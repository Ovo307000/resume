...
const projectsData = [
  ...
  },
  {
    name: "Sky Takeout",
    nameZh: "天空外卖",
    url: "https://github.com/Ovo307000/skytakeout",
    description: "Food delivery platform for restaurants and customers",
    descriptionZh: "为餐厅和顾客提供的外卖平台",
    longDescription: "A comprehensive food delivery system with separate interfaces for restaurants, delivery personnel, and customers. Features include menu management, order tracking, real-time notifications, and payment processing.",
    technologies: ["Java", "Spring Boot", "Redis", "MySQL", "WebSocket", "Vue.js"],
    ...
    category: "web",
    githubUrl: "https://github.com/Ovo307000/skytakeout"
  }
];
